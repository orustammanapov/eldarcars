...
export default function Slider({ images }) {
  // Dummy image data
  // const images = [
  //   'https://placehold.co/1200x800?text=Image+1',
  //   'https://placehold.co/1200x800?text=Image+2',
  //   'https://placehold.co/1200x800?text=Image+3',
  //   'https://placehold.co/1200x800?text=Image+4',
  //   'https://placehold.co/1200x800?text=Image+5',
  //   'https://placehold.co/1200x800?text=Image+6',
  //   'https://placehold.co/1200x800?text=Image+7',
  //   'https://placehold.co/1200x800?text=Image+8',
  //   'https://placehold.co/1200x800?text=Image+9',
  //   'https://placehold.co/1200x800?text=Image+10',
  //   'https://placehold.co/1200x800?text=Image+11',
  // ];
  ...
  const prevImage = () => {
    setActive((prevIndex) => (prevIndex === 0 ? images.length - 1 : prevIndex - 1));
  };

  // Navigate to the next image
  const nextImage = () => {
    setActive((prevIndex) => (prevIndex === images.length - 1 ? 0 : prevIndex + 1));
  };
      ...
      <div className="relative w-full">
        ...
        <section className="flex space-x-2 overflow-hidden">
          {images.map((image, index) => (
            <button className="flex-none" key={index} onClick={() => setActive(index)}>
              <img
                src={image}
